              ...
              <div>
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center" v-for="item in departments"
                          :key="item._id">
                    {{item.name}}
					<b :to="{name: 'Department', params: { id: item._id }}">
...
//    created() {
//         let apiURL = `${this.baseUrl}/edit_department/${this.$route.params.id}`;
...
//     },
  methods: {
	...
	// handleUpdateForm() {
    //         let apiURL = `${this.baseUrl}/update_department/${this.$route.params.id}`;
    //         axios.post(apiURL, this.department).then((res) => {
    //             console.log(res)
    //             this.$router.push('/admin/department')
    //         }).catch(error => {
    //             console.log(error)
